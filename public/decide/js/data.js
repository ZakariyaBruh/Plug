...
(function (root, factory) {
  ...
  var ITEMS = [
    ...
    item('Chicken shawarma', '\u{1F959}', 'Shaved off the spit, garlic sauce, pickles, no regrets.',
      'hot meat handheld messy filling spicy chicken allium bready'),
    ...
    item('Chicken katsu curry', '\u{1F35B}', 'Breadcrumbed, fried, sliced, and drowned in brown sauce.',
      'hot meat fried crunchy comfort carby filling chicken egg allium root', 'indulgent'),
    ...
    item('Bolognese', '\u{1F35D}', 'Cooked far longer than the recipe on the jar suggests.',
      'hot meat carby comfort filling beef dairy allium root homemade soft alcohol'),
    ...
    item('Chicken wings', '\u{1F357}', 'A pile of them, a lot of napkins, and nothing else needed.',
      'hot meat fried crunchy shareable messy spicy chicken dairy indulgent filling'),
