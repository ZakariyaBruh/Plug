...
(function (root, factory) {
  ...
  var ITEMS = [
    ...
    item('Pierogi ruskie', '\u{1F95F}', 'Potato and curd cheese inside, fried onions on top.',
      'hot soft comfort filling dairy egg carby allium root homemade'),
    ...
    item('Beef rendang', '\u{1F35B}', 'Simmered until the sauce disappears into the meat. Hours, and worth it.',
      'hot meat spicy comfort filling indulgent beef allium root soft homemade'),
